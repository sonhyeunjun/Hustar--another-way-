...
String sql2 = " select userid,username,mobile,gender,birthday,university,email,rdate " 
	    	+ " from memberinfo "
                  ...
                  <div class="col-md-12">
                    <div class="card-body p-md-5 text-black">
                      <h3 class="mb-5 text-uppercase">회원가입</h3>
                        ...
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                            ...
                            <button type="button"  onclick="fn_idcheck()" class="site-btn">중복체크</button>
                          </div>
                        </div>
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                            <input type="password" id="form3Example1m1" class="form-control form-control-lg" name="pass"/>
                            <label class="form-label" for="form3Example1m1">비밀번호</label>
                          </div>
                        </div>
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                            <input type="text" id="form3Example1n1" class="form-control form-control-lg" name="mobile" />
                      ...
                      <div class="form-outline mb-4">
                        <input type="date" id="form3Example9" class="form-control form-control-lg" name="birthday" />
